...
type FrameworkIdentifier =
    ...
    member internal x.RawSupportedPlatforms =
        ...
        // remark: for now, os versions for net 10 is alias to 9
        | DotNet10WithOs  Net9Os.Android -> [ DotNetFramework FrameworkVersion.V10; MonoAndroid MonoAndroidVersion.V12 ]
        | DotNet10WithOs  Net9Os.IOs     -> [ DotNetFramework FrameworkVersion.V10; XamariniOS ]
        | DotNet10WithOs  Net9Os.MacOs   -> [ DotNetFramework FrameworkVersion.V10; XamarinMac ]
        | DotNet10WithOs  Net9Os.TvOs    -> [ DotNetFramework FrameworkVersion.V10; XamarinTV ]
        | DotNet10WithOs  Net9Os.WatchOs -> [ DotNetFramework FrameworkVersion.V10; XamarinWatch ]
        ...
        // remark: for now, windows version for net 10 is alias to 9
